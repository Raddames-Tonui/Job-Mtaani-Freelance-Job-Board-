...
Revision ID: d676af24fdd1
Revises: 
Create Date: 2024-08-13 16:03:59.771639
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('freelancer_id', 'client_id', name='unique_freelancer_client')
    )
