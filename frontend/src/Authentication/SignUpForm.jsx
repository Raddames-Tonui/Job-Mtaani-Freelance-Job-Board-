...
function SignUpForm() {
    // Access the register_user function from UserContext
    ...
    const [avatar, setAvatar] = useState(""); // State for avatar URL input
    ...
    function handleSubmit(e) {
      ...
      if (password !== repeatPassword) {
        toast.error("Passwords do not match"); // Show error message if passwords don't match
      } else {
        // Call the register_user function from context
