      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {freelancers.map((freelancer) => (
          <div key={freelancer.id} className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-semibold mb-2">{freelancer.username}</h2>
            <h3 className='font-semibold underline'> Skills</h3>
            <p>{freelancer.skills}</p>
            <h3 className='font-semibold underline'>Experience</h3>
